  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        ...
        {!editing && (
          <div style={{ color: '#99a0ae', fontSize: 12, marginTop: 4 }}>{displayValue}</div>
        )}
      </div>
      ...
      {editing ? (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          {inputType === 'boolean' ? (
            <select
              ...
              style={{
                background: '#0e121b', border: '1px solid #2b303b', borderRadius: 8,
            ...
            <input
              ...
              onChange={e => setEditValue(e.target.value)}
              style={{
                width: 80, background: '#0e121b', border: '1px solid #2b303b',
        ...
        <button onClick={startEdit} style={{
          background: '#2b303b', border: 'none', borderRadius: 6,
          padding: '6px', cursor: 'pointer', display: 'flex'
        }}>
          <Edit2 size={14} color="#99a0ae" />
        </button>
      )}
    </div>
  )
