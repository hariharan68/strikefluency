...
import {
  ...
  Linkedin, MessageCircle, Moon, Music2, PhoneCall, Sun, TrendingUp
} from 'lucide-react'
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-5 md:px-8">
        ...
        <div className="flex flex-shrink-0 items-center gap-2">
          <button
            ...
            title="Toggle theme"
            className="grid h-9 w-9 place-items-center rounded-full border border-[var(--border)] text-[var(--text-sub)] hover:text-[var(--primary)] hover:border-[var(--primary-border)]"
          >
