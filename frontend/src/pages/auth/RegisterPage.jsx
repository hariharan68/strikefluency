    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <p style={{ color: '#64748b', fontSize: 13 }}>Start your trading journey</p>
        </div>

        <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 14, padding: 32, boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
          <h2 style={{ color: '#1e293b', fontSize: 16, fontWeight: 600, marginBottom: 20 }}>Create your account</h2>
          <form onSubmit={e => { e.preventDefault(); submit(fullName, email, password) }} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div>
              <label className="sf-label">Full Name</label>
              <input className="sf-input" type="text" placeholder="Arjun Sharma"
            ...
            <button type="submit" disabled={loading} className="sf-btn-primary"
              style={{ marginTop: 4, height: 42, fontSize: 14 }}>
